...
| commonLabels | object | `{}` |  |
| config.gtpc.client.sgwc.address | string | `""` |  |
| config.gtpc.client.sgwc.tac | int | `1` |  |
| config.gtpc.client.smf.address | string | `""` |  |
| config.gtpc.client.smf.tac | int | `1` |  |
| config.gtpc.server | string | `nil` |  |
